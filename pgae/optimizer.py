...
class OptimizerAE(object):
    def __init__(self, preds, labels, pos_weight, norm, d_real, d_fake, d_fake_p):
        preds_sub = preds
        labels_sub = labels
        ...
        generator_loss = tf.reduce_mean(
            tf.nn.sigmoid_cross_entropy_with_logits(labels=tf.ones_like(d_fake_p), logits=d_fake_p, name='gl'))
...
class OptimizerVAE(object):
    def __init__(self, preds, labels, model, num_nodes, pos_weight, norm, d_real, d_fake, d_fake_p):
        preds_sub = preds
        labels_sub = labels
        ...
        self.generator_loss = tf.reduce_mean(
            tf.nn.sigmoid_cross_entropy_with_logits(labels=tf.ones_like(d_fake_p), logits=d_fake_p))
